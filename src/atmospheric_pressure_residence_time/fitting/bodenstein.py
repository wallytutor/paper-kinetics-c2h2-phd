...
files = [(loads[0]+temps[0]+flows[0], 800, (0,1), 'u'+temps[0]+flows[0]),\
         (loads[0]+temps[1]+flows[0], 100, (0,1), 'u'+temps[1]+flows[0]),\
         (loads[0]+temps[1]+flows[1], 65,  (0,1), 'u'+temps[1]+flows[1]),\
         (loads[1]+temps[0]+flows[0], 850, (0,1), 'l'+temps[0]+flows[0]),\
         (loads[1]+temps[1]+flows[0], 850, (0,1), 'l'+temps[1]+flows[0]),\
         (loads[1]+temps[1]+flows[1], 370, (0,1), 'l'+temps[1]+flows[1])]
...
src  = "./../unloaded/T1173K_D0250CCN2"
crop = 250
cols = (0,1)
title= "uT1173K_D0500CCN2"
fit_bodenstein(src+'.dat', crop, cols, title=title, plot=True)
